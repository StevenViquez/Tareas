...
function validarDatos(){
    ...
    if(user.clave == user.nclave){
        ...
        if(!users){
            ...
            localStorage.setItem("user", JSON.stringify(user));//para saber cual es el usuario de la otra pantalla
...
function redireccionar(){
  window.locationf="file:///C:/Users/Steven/Desktop/Proyecto/html/login.html";;
} 
